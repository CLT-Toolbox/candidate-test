    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg">
                <div class="p-6">
                    <form action="{{ route('dashboard.layups.update', $layup) }}" method="POST">
                        @csrf
                        @method('PUT')

                        {{-- Layup Info Card --}}
                        <div class="flex items-center gap-4 mb-6 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                            <div class="flex-shrink-0 h-16 w-16 bg-green-100 dark:bg-green-900/30 
                            ...
                            <div class="flex-1">
                                <p class="text-sm text-gray-500 dark:text-gray-400">Layup Name</p>
