<x-app-layout>
    ...
    <div class="py-1" x-data="supplierManager()"
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="border-b border-gray-100 pb-4 dark:border-gray-700">
                <div class="flex justify-between gap-2">
                    ...
                    <div class="flex gap-2">
                        ...
                        <button class="rounded-md border border-gray-300 bg-white px-3 py-1.5 text-sm font-medium text-gray-700 transition hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600">
                            {{ __('Export') }}
                        </button>
                    </div>
                </div>
            ...
            {{-- Suppliers Table --}}
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800 border border-[#D1D5DB]">
                <div class="overflow-x-auto">
                    <table class="w-full">
                        <thead class="bg-[#F9FAFB]">
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                <th class="px-6 py-4 text-left text-[11px] font-semibold uppercase tracking-widest text-[#4B5563] dark:text-gray-400">
                                    {{ __('Name') }}
                                </th>
                                <th class="px-6 py-4 text-left text-[11px] font-semibold uppercase tracking-widest text-[#4B5563] dark:text-gray-400">
                                    {{ __('Total Layups') }}
                                ...
                                <th class="px-6 py-4 text-right text-[11px] font-semibold uppercase tracking-widest text-[#4B5563] dark:text-gray-400">
                                    {{ __('Actions') }}
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            @forelse ($suppliers as $supplier)
                                <tr class="border-b border-gray-100 transition-colors duration-150 hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-700/50">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-blue-50 text-sm font-semibold text-blue-600 dark:bg-blue-900/30 dark:text-blue-400">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex items-center justify-end gap-2">
                                            <button class="rounded-lg border border-gray-300 px-3 py-1.5 text-sm text-gray-600 transition-all duration-150 hover:border-gray-400 hover:bg-gray-100 dark:border-gray-600 dark:text-gray-400 dark:hover:border-gray-500 dark:hover:bg-gray-700"
                                                @click="window.dispatchEvent(new CustomEvent('open-edit-modal', { detail: { id: {{ $supplier->id }}, name: '{{ addslashes($supplier->name) }}' } }))">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="-0.5 -0.5 16 16" fill="none" height="25" width="16" class="text-gray-700 dark:text-gray-300">
                                            ...
                                            <button type="button"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" height="24" width="16" class="text-gray-700 dark:text-gray-300">
                                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M1 5h22" stroke-width="1.5"></path>
                                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                                    ...
                                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M9.75 17.75v-7.5" stroke-width="1.5"></path>
                                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M14.25 17.75v-7.5" stroke-width="1.5"></path>
                                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="flex items-center justify-between border-t border-gray-200 bg-white px-6 py-3 dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <div class="flex gap-2">
                        @if ($suppliers->onFirstPage())
                            <button disabled class="cursor-not-allowed rounded-md border border-gray-300 bg-white px-2 py-1 text-gray-400 dark:border-gray-600 dark:bg-gray-700">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" class="h-4 w-4" fill="currentColor">
                                    <path d="M3.8486400000000005 7.209265000000001c-0.437355 0.437355 -0.437355 1.147615 0 1.5849700000000002l6.71775 6.71775c0.437355 0.437355 1.147615 0.437355 1.5849700000000002 0s0.437355 -1.147615 0 -1.5849700000000002L6.2243450000000005 8 12.147860000000001 2.072985c0.437355 -0.437355 0.437355 -1.147615 0 -1.5849700000000002s-1.147615 -0.437355 -1.5849700000000002 0l-6.71775 6.71775Z" />
                                </svg>
                            </button>
                        @else
