<x-app-layout>
    ...
    <div class="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 flex items-center justify-between gap-4">
            ...
            <!-- Export Button -->
            <a href="{{ route('suppliers.export-list') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 bg-white text-sm rounded-lg hover:bg-gray-50 transition">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
