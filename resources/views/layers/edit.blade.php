...
<div class="py-12">
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg">
            <div class="p-6">
                <form action="{{ route('dashboard.layers.update', $layer) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex items-center gap-4 mb-6 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                        ...
                        <div>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Layer Order</p>
                            <p class="text-lg font-semibold text-gray-900 dark:text-white">#{{ $layer->layer_order }}</p>
                        </div>
                        <div class="ml-auto text-right">
                            <p class="text-sm text-gray-500 dark:text-gray-400">Layup</p>
                            <p class="text-sm font-medium text-gray-900 dark:text-white">{{ $layer->layup->name }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        {{-- ✅ CANCEL BUTTON - Pakai $layer->layup --}}
                        <a href="{{ route('dashboard.layups.show', $layer->layup) }}"
            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                        ...
                        <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ $layer->created_at->format('M d, Y H:i') }}</p>
                    </div>
                    <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Last Updated</p>
                        <p class="text-lg font-semibold text-gray-900 dark:text-white">{{ $layer->updated_at->format('M d, Y H:i') }}</p>
                    </div>
                </div>
            </div>
        </div>
